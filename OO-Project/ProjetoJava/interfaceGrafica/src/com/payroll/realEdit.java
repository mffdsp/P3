...
public class realEdit extends JFrame {
	 ...
	 * Create the frame.
	 */
	public realEdit(Funcionario func) {
		...
		textField.setText(Double.toString(func.getSalary()));	
		textField.setBackground(SystemColor.menu);
		textField.setBounds(77, 384, 57, 24);
		panel.add(textField);
		
		textField_1 = new JTextField();
		textField_1.setText(func.getAdress());
		...
		textField_2.setText(func.getName());
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] { func.getPayMode(), "Maos", "Deposito"}));
