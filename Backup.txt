	...
	public class Main {
	    ...
	    private static int Asegundo = 30;
	    //USAR MODULO
	    ...
	    private static int[] Ssegundo = new int[1000];
	    	//Date
	    private static Date[] Etime = new Date[1000];
	    private static Date[] Stime = new Date[1000];
